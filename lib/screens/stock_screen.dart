// lib/screens/add_payment_screen.dart - v2.0 (Intelligent & Polished)
...
class _AddPaymentScreenState extends State<AddPaymentScreen> {
  ...
  Future<void> _loadClients() async {
    ...
    if (mounted) {
      setState(() {
        _clients = c;
        // Pre-select client if an ID was passed to the screen
  ...
  // ✅ UPDATED: Now uses targeted sync and better validation
  Future<void> _save() async {
    ...
    try {
      ...
      // ✅ Use targeted sync instead of syncAllData() for better performance
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ✅ SMART WIDGET: Autocomplete for clients
            Autocomplete<Client>(
              ...
              onSelected: (Client selection) {
                ...
                FocusScope.of(context).requestFocus(_amountFocusNode); // Move focus to amount field
              },
              fieldViewBuilder: (context, controller, focusNode, onFieldSubmitted) {
                _clientCtrl.text = controller.text;
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text('Please add a client before recording a payment.', style: TextStyle(color: Colors.grey.shade600)),
        ],
      ),
    );
  }
